...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Whois", description="Retrieves whois information for IPv4 and IPv6 hosts, and outputs it to your console ...\n\nTip: Query \"?\" to get a help message sent directly from the whois server ...")
    ...
    try:
        ...
        print("[!] Failed to execute whois query against \"{}\" on port \"{}\":".format(args.server, args.port))
        print("    " + str(e))
